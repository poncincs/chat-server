...
if (
    ...
    !empty($_POST['email-register']) &&
    !empty($_POST['uname-register']) &&
    !empty($_POST['psw-register']) &&
    ...
    if ($_POST['psw-signup'] === $_POST['psw-repeat']) {
        ...
        $email_secur = (htmlentities(addslashes(htmlspecialchars($_POST['email-register']))));
        $uname_secur = (htmlentities(addslashes(htmlspecialchars($_POST['uname-register']))));
        $psw_secur = (htmlentities(addslashes(htmlspecialchars($_POST['psw-register']))));
        ...
        try {
            ...
            $addUser = $dbChatServer->prepare("INSERT INTO users(full_name, email, username, password) VALUES (:full_name, :email, :username, :password)");
            $addUser->execute([
                'full_name' => $full_name,
                'email' => $email_secur,
                'username' => $uname_secur,
